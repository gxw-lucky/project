...
<html>
	...
	<body>
		<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 成绩管理 <span class="c-gray en">&gt;</span> 基础信息
		...
		<div class="page-container">
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<div class="l">
					...
					<a href="javascript:;" onclick="add('添加废品','scrap-add.jsp')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加成绩</a> -->
					<a href="/project/Student/inputExcel"  class="btn btn-primary radius">Excel导出</a>
				</div>
				<div class="r">
					<input type="text" id="search" placeholder="学籍号" style="width:250px" class="input-text">
			...
			<table class="table table-border table-bordered table-hover table-bg table-sort" width="100%">
				...
				<tbody>
				<c:forEach items="${subScore }" var="o" varStatus="status">
				<tr>
				<td>${status.index+1 }</td>
				<td>${o.xjh }</td>
				<td>${o.xm }</td>
				<td>${o.list[0].score }</td>
				<td>${o.list[1].score }</td>
				<td>${o.list[2].score }</td>
				<td></td>
				</tr>
				</c:forEach>
				</tbody>
