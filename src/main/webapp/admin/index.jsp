			...
			<div class="menu_dropdown bk_2">
				...
				<dl id="menu-scrap">
					...
					<dd>
						<ul>
							<li>
								<a _href="scrap-list.jsp" data-title="学生信息表" href="javascript:void(0)">学生信息表</a>
								<a _href="/project/score/selectAnYuanShiScore" data-title="单科原始成绩" href="javascript:void(0)">单科原始成绩</a>
								<a _href="score-list.jsp" data-title="学生原始成绩" href="javascript:void(0)">学生原始成绩</a>
								<a _href="dkffScore.jsp" data-title="单科赋分成绩" href="javascript:void(0)">单科赋分成绩</a>
								<a _href="ffScore.jsp" data-title="学生赋分总成绩" href="javascript:void(0)">学生赋分总成绩</a>
							</li>
						</ul>
					</dd>
				</dl>
				<dl id="menu-scrap-collector">
					<dt><i class="Hui-iconfont">&#xe613;</i> 排名<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
					<dd>
						<ul>
							<li>
								<a _href="scrap-collector-list.jsp" data-title="学校原始排名" href="javascript:void(0)">学校原始排名</a>
								<a _href="scrap-collector-list.jsp" data-title="班级原始排名" href="javascript:void(0)">班级原始排名</a>
								<a _href="scrap-collector-list.jsp" data-title="赋分总成绩排名" href="javascript:void(0)">赋分总成绩排名</a>
							</li>
						</ul>
					</dd>
					<dt><i class="Hui-iconfont">&#xe613;</i> 平均分统计<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
					<dd>
						<ul>
							<li>
								<a _href="/project/char/secre.html" data-title="学校原始排名" href="javascript:void(0)">学校单科平均分</a>
								<a _href="scrap-collector-list.jsp" data-title="班级原始排名" href="javascript:void(0)">班级单科平均分</a>
								<a _href="scrap-collector-list.jsp" data-title="赋分总成绩排名" href="javascript:void(0)">全市单科平均分</a>
							</li>
						</ul>
					</dd>
					<dt><i class="Hui-iconfont">&#xe613;</i> 最高分统计<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
					<dd>
						<ul>
							<li>
								<a _href="/project/char/dkzgScore.jsp" data-title="学校单科最高分" href="javascript:void(0)">学校单科最高分</a>
								<a _href="scrap-collector-list.jsp" data-title="班级单科最高分" href="javascript:void(0)">班级单科最高分</a>
								<a _href="/project/char/qsdkzgScore.jsp" data-title="全市单科最高分" href="javascript:void(0)">全市单科最高分</a>
							</li>
						</ul>
					</dd>
					<dt><i class="Hui-iconfont">&#xe613;</i> 科目按学生统计<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
					<dd>
						<ul>
							<li>
								<a _href="scrap-collector-list.jsp" data-title="得分明细" href="javascript:void(0)">得分明细</a>
								<a _href="scrap-collector-list.jsp" data-title="客观题得分" href="javascript:void(0)">客观题得分</a>
								<a _href="scrap-collector-list.jsp" data-title="主观题得分" href="javascript:void(0)">主观题得分</a>
							</li>
						</ul>
					</dd>
					<dt><i class="Hui-iconfont">&#xe613;</i> 科目按题统计<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
					<dd>
						<ul>
							<li>
								<a _href="scrap-collector-list.jsp" data-title="全市每题得分率" href="javascript:void(0)">全市每题得分率</a>
								<a _href="scrap-collector-list.jsp" data-title="学校每题得分率" href="javascript:void(0)">学校每题得分率</a>
								<a _href="scrap-collector-list.jsp" data-title="班级每题得分率" href="javascript:void(0)">班级每题得分率</a>
							</li>
						</ul>
					</dd>
					<dt><i class="Hui-iconfont">&#xe613;</i> 及格率<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
					<dd>
						<ul>
							<li>
								<a _href="scrap-collector-list.jsp" data-title="全市及格率" href="javascript:void(0)">全市及格率</a>
								<a _href="scrap-collector-list.jsp" data-title="全市及格率" href="javascript:void(0)">全市及格率</a>
								<a _href="scrap-collector-list.jsp" data-title="班级及格率" href="javascript:void(0)">班级及格率</a>
							</li>
						</ul>
					</dd>
				</dl>
				<dl id="menu-reclamation-order">
					<dt><i class="Hui-iconfont">&#xe622;</i> 多次考试对比<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
					<dd>
						<ul>
							<li>
								<!-- <a _href="reclamation-order-list.jsp" data-title="废品回收订单管理" href="javascript:void(0);">废品回收订单管理</a> -->
								<a _href="reclamation-order-list.jsp" data-title="超均率" href="javascript:void(0);">超均率</a>
								<a _href="reclamation-order-list.jsp" data-title="超均人数" href="javascript:void(0);">超均人数</a>
							</li>
						</ul>
					</dd>
				</dl>
