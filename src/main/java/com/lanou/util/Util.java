...
public class Util {
  ...
  public static void main(String[] args) {
    Util ee = new Util();
    String[][] content = new String[][] { { "学生信息表", "学籍号", "学生考号", "学生姓名","班级名称","学校名称" },
        { "第一行", "111", "111", "刘磊","七一","zz" }, { "第二行", "111", "111", "刘磊","七一","zz" },
        { "第三行", "111", "111", "刘磊","七一","zz" } };
    try {
      OutputStream os = new FileOutputStream("E:/test2.xls");
